...
import 'package:tblpartes/search_widget.dart';
...
class Comandante extends StatefulWidget {
  Comandante({
    Key? key,
  }) : super(key: key);

  @override
  _ComandanteState createState() => _ComandanteState();
}

class _ComandanteState extends State<Comandante> with AutomaticKeepAliveClientMixin {
  List<dynamic> lista = [];
...
class _Lista extends StatefulWidget {
  const _Lista({Key? key, required this.lista, required this.listaTest}) : super(key: key);
  final StreamController<List<dynamic>> lista;
  final List<dynamic> listaTest;
  @override
  _ListaState createState() => _ListaState();
}

class _ListaState extends State<_Lista> with AutomaticKeepAliveClientMixin {
  List<dynamic> list = [];
  @override
  Widget build(BuildContext context) {
    super.build(context);
...
class _Home extends StatefulWidget {
  const _Home({Key? key, this.hora}) : super(key: key);
  final String? hora;
  @override
